...
function loadMap(Q) {
    ...
    Board = Q.Board
    Paths = Q.Paths
    (!Number.isInteger(Set) || !Set) return spurn(Set,0)
    Clear()
}
...
function Check() {
    ...
    alert(massage ? massage : (location.href=`In-game?${Level[1]}?${++Level[2]}`,"완료!"))
}
...
function hintPaths(Object) {
    ...
    if (Object.Array == 0) return spurn(JSON.stringify(Object.Array),5)
